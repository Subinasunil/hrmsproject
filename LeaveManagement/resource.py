...
class AttendanceResource(resources.ModelResource):
    ...
    #             schedule = EmployeeShiftSchedule.objects.filter(employee=employee).first()
    #             if schedule:
    #                 shift = schedule.get_shift_for_date(date)  # Pass date here
    #                 attendance.shift = shift
    ...
    #     # Check if `date` is an instance of `datetime.datetime`
    ...
    #             # Ensure date is passed to get_shift_for_date as `datetime.date`
    ...
    #             # Assign shift
    #             schedule = EmployeeShiftSchedule.objects.filter(employee=employee).first()
    #             shift = schedule.get_shift_for_date(attendance.date) if schedule else None
    #             attendance.shift = shift
