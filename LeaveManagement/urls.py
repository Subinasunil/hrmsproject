...
from .views import (Applicableviewset,LeaveTypeviewset,LeaveEntitlementviewset,LeaveRequestviewset,LeaveTypeViewSet,leave_balance_viewset,Acrualviewset,Resetviewset,
                    ...
                    AttendanceReportViewset,LvBalanceReportViewset,CompensatoryLeaveRequestviewset,CompensatoryLeaveBalancetviewset,CompensatoryLeaveTransactionviewset,
                    ShiftPatternViewSet,EmployeeShiftScheduleViewSet,ShiftOverrideViewSet,WeekPatternAssignmentVSet,EmployeeRejoiningviewset
...
router.register(r'CompensatoryLeaveRequest', CompensatoryLeaveRequestviewset, basename='emp_compnstry_lv')
router.register(r'emp_compnstry_lv_blnce', CompensatoryLeaveBalancetviewset, basename='emp_compnstry_lv_blnce')
router.register(r'emp-cmpnstry-lv-transaction', CompensatoryLeaveTransactionviewset, basename='emp-cmpnstry-lv-transaction')
router.register(r'emp-Rejoining',EmployeeRejoiningviewset, basename='emp-Rejoining')
